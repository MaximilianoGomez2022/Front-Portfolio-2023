...
import developerAnimation from "../../src/assets/estudios.json";
...
function Content(props){
    ...
    return (
        <div className="Content">
            ...
            <div className="titulo" data-aos="fade-up" style={{marginTop: "80px"}}>
                <h2>EXPERIENCIA LABORAL</h2>
            </div>
            <div className="sobremi">

                <div className="sobremi-experiencia">

                    <div className="info-yo" data-aos="fade-right" data-aos-duration="1000">
                        <h3>AGENCIA VALOR DIGITAL</h3>
                        <p>Haciendo los bocetos para los clientes y luego la maquetación y el diseño en css, en la plataforma Wordpress. Uso de Filezilla para subir archivos al servidor.</p>
                    </div>

                    <div className="info-estudios" data-aos="fade-right" data-aos-duration="1200">
                        <h3>FIXEAR</h3>
                        <p>Como desarrollador front-end modificando un proyecto ya hecho, cambiando funcionalidad y diseños usando el framework Vue.js. Uso de gitlab para las versiones del proyecto y comandos desde la terminal para ubicar el proyecto en el servidor.</p>
                    </div>

                    <div className="info-yo" data-aos="fade-right" data-aos-duration="1400">
                        <h3>ACQ IT</h3>
                        <p>Usando Laravel para el backend, modificando funcionalidades del sistema interno de la empresa basado en una ticketera de tareas y peticiones de los clientes. Uso de Teams, outlook, Microsoft SQL server para ver las bases de datos. Gitlab para las versiones del proyecto y las ramas de cada uno de nuestro equipo. Para el front end usamos javascript vanilla en el mismo blade de Laravel. Un poco de uso de docker.</p>
                    </div>

                    <div className="info-estudios" data-aos="fade-right" data-aos-duration="1600">
                        <h3>CASINOSOFT</h3>
                        <p>Uso de Laravel para toda la aplicación. Integración de métodos de pago ( MercadoPago, EtPay, Cripten ). CRUD, Vistas, Reportes financieros. Conectarse a los servers mediante SSH y pem. Conectarse a la base mediante tunel ssh en Dbeaver. Consultas SQL. Javascript vanilla y jquery en los blade. AJAX. Uso de gitlab y docker.</p>
                    </div>
            ...
            <section id="habilidades">
                ...
                <div className="titulo mb-3" data-aos="fade-up">
                    <h2>HABILIDADES</h2>
                </div>

                <div className="flex-container-habilidades">
        ...
        <div className='separador-contacto'></div>
            ...
            <div class="contacto container">
                <div className='row'>
                <div className='col-md-6 img-contacto'>
